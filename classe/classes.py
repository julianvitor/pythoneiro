...
class Pessoa:
    ...
    def __init__(self, nome, idade):
        self.nome = (
            nome  # Self.nome é uma caracteristica de Pessoa e ela recebe o valor "nome"
        )
...
print(
    p1
)  # é assim que um objeto se parece sem o metodo __str__. Na ausencia do metodo __str__ o python chama o metodo __repr__
...
class Vazia:
    pass  # definições de classe não podem ser vazios, faz necessario o uso do Statment pass
...
class Estudante(Nome):
    pass  # classe herdeira que utiliza a função __init__ da classe pai e seus metodos
...
for (
    ...
    lista
):  # o loop for cria um objeto iterador e executa o metodo next() para cada loop
    print(i)
